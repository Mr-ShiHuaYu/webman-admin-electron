...
class FrameworkController extends Controller {
  ...
  //  * 启动webman项目
  //  */
  // async startWebmanServer() {
  //   let data = {
  //     code: 0,
  //     msg: '',
  //     server: ''
  //   }
  //   const webmanCfg = Conf.getValue('addons.webman') || {};
  //   if (!webmanCfg.enable) {
  //     data.code = -1;
  //     data.msg = 'addon not enabled!';
  //     return data;
  //   }
  //
  //   await Addon.get('webman').createServer();
  //
  //   data.server = `http://${webmanCfg.hostname}:webmanCfg.port`;
  //
  //   return data;
  // }
  //
